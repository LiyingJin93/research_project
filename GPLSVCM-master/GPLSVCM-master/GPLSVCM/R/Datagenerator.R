...
Datagenerator=function(family, ngrid){
  ...
  if(family$family=="gaussian"){
    ...
    y=1+m1*x1+m2*x2+r1*x3+r2*x4+eps
  ...
  # m1=m1
  # m2=m2
  #  logit_mu=m1*x1+m2*x2+r1*x3+r2*x4
  # mu=inv.logit(logit_mu)
  # y=mu
  #for(i in 1:N){
  #  y[i]=suppressWarnings(rbinom(1,size=1,prob=mu[i]))
  # }
  # }
pop=as.matrix(cbind(y,m1,m2,r1,r2,x1,x2,x3,x4,u,v))
pop=pop[!is.na(pop[,'m1']),]
return(pop)
}


# modified alpha_2 coefficient function:
